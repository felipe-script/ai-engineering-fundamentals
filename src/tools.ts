...
export const tools = {
    generateDiagram: tool({
        description: 'Generate a complete  diagram as an array of Excalidraw elements. use this when the user asks for you create , draw or design a new diagram. return all elements needed including shapes, arrows, text, labels and arrow lines connecting them.'
